...
echo "Replacing ~/keyboards/crkbd/keymaps/sara/keymap.json with the new version at ~/Downloads/sara.json"
rm $ROOTDIR/keyboards/crkbd/keymaps/sara/keymap.json
mv ~/Downloads/sara.json $ROOTDIR/keyboards/crkbd/keymaps/sara/keymap.json